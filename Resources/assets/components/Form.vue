            ...
            <form class="m-form m-form--fit m-form--label-align-right" v-on:submit.prevent="submit($event)">
                <div class="m-portlet__body">
                    ...
                    <div class="form-group m-form__group d-md-flex">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control m-input slugify" data-target="slug" name="name" placeholder="Role Name" v-model="data.name">
                        </div>
                    </div>
                    <div class="form-group m-form__group d-md-flex">
                        <div class="col-md-4 d-md-flex justify-content-end align-items-center py-3">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control m-input" name="slug" placeholder="Role Slug"  v-model="data.slug" readonly>
                        </div>
                    </div>
                    <div class="form-group m-form__group d-md-flex">
                        <div class="col-md-4 d-md-flex justify-content-end align-items-center py-3">
                        ...
                        <div class="col-md-8">
                            <textarea class="form-control m-input autosize" type="text" name="description" placeholder="Role Description" v-model="data.description"></textarea>
                        </div>
                    </div>
                </div>
