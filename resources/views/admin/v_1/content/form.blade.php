...
<div class="row">
    <div class="col-sm-12">
        ...
        <div class="m-portlet m-portlet--tab">
            ...
            <!--begin::Form-->
            <form class="m-form m-form--fit m-form--label-align-right" action="{{action('\Gdevilbat\SpardaCMS\Modules\Role\Http\Controllers\RoleController@store')}}" method="post">
